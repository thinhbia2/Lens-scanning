...
class MeasurementApp:
    ...
    def create_configuration_tab(self, notebook):
        ...
        ttk.Label(config_frame, text=f"IP: {ip_address}").grid(row=row, column=0, padx=10, pady=5, sticky="w")
    ...
    def start_tcp_server(self, port):
        try:
            ...
            self.sn.timeTrace.setNumBins(int(self.default_bin_width))
            self.sn.timeTrace.setHistorySize(int(self.default_window_size))
            self.sn.timeTrace.measure(900000, waitFinished=False, savePTU=False)
                        ...
                        try:
                            ...
                            if data:
                                ...
                                if data == "Start":
                                    ...
                                    self.client_socket.sendall("Incorrect data".encode('utf-8'))
                            else:
